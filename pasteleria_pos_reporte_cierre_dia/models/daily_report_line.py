...
class PasteleriaPosDailyReportLine(models.Model):
    ...
    _description = "Línea de reporte final del día POS"
    _order = "sequence asc, id asc"

    report_id = fields.Many2one("pasteleria.pos.daily.report", string="Reporte", required=True, ondelete="cascade")
    sequence = fields.Integer(string="Secuencia", default=10)
    line_type = fields.Selection(
        [("section", "Sección"), ("data", "Dato")],
        string="Tipo",
        default="data",
        required=True,
    )
    ...
    sales_amount_q = fields.Monetary(string="VTA-Q", currency_field="currency_id")
